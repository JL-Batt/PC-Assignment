/*********************************************************************************************************
 * FILENAME -     bruteserial.c
 * 
 * DESCRIPTION -  Source file that conducts a Brute Force Search for a 16 bit Key in order to
 *                Decrypt a Plain Text Message, operating sequentially/ in serial. The program will 
...
int main (void)
{
  /* Get start time of program. Note - Measuring time using wall clock time 
  on a single thread for the serial version is more accurate than measuring 
  using clock ticks */
  ...
  /* Nested For Loops used to search each of the 4 actual characters in the key */
